      ...
      <section className="container" style={{ paddingTop: '30px' }}>
        <div className="row align-items-center">
          ...
          <div className="col">
            ...
            <h5 className="h2 font-weight-light line-height-2 my-3" style={{ fontSize: '1.75rem'}}>{data.content}</h5>
            <span className="text-gray-500" style={{ display: "block", fontWeight: 300 }}>
