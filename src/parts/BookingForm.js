        ...
        return (
          <div className="card bordered" style={{ padding: "60px 80px" }}>
            ...
            <h5 className="h2 text-teal mb-4">
              ${itemDetails.price} <span className="text-gray-500 font-weight-li">per {itemDetails.unit}</span>
            </h5>

            <label htmlFor="duration">How long you will stay?</label>
            <InputNumber max={30} suffix={" night"} isSuffixPlural onChange={this.updateData} name="duration" value={data.duration}/>

            <label htmlFor="date" style={{ marginTop: '8px' }}>Pick a date</label>
            <InputDate onChange={this.updateData} name="date" value={data.date} />

            <h6 className="text-gray-500 font-weight-light" style={{ marginBottom: 40, width: "100%" }}>
              You will pay{" "}
